...
\lhead{\begin{otherlanguage}{hebrew}{\vbox{\large\null\par\textbf{\contestname}\\[-1pt]\textbf{\tOverviewSheet}\\[-1pt] \tLang:\enspace\textbf{\TemplateLanguage}}}\end{otherlanguage}\vskip-5pt}}{
\lhead{\hskip-17pt\includegraphics[scale=.5]{header.pdf}}
\rhead{\vbox{\large\textbf{\contestname}\\[1pt]\textbf{\tOverviewSheet}\\[1pt]\tLang:\enspace\textbf{\TemplateLanguage}\par\vskip9.5pt}}}
