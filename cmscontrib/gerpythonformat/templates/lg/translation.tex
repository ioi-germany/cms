...
\def\tContestServer{Du findest unser Wettbewerbssystem unter \texttt{???}.}
...
%Task overview section
\def\tContestServer{You can find our contest server at \texttt{???}.}
...
\def\tTaskType{Type}
\def\tTTBatch{batch}
\def\tTTCommunication{interactive}
