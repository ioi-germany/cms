...
\ifthenelse{\equal{\TemplateLanguage}{lt}}{
    \usepackage[lithuanian]{babel}
}{
\ifthenelse{\equal{\TemplateLanguage}{lv}}{
...
\lhead{\vspace{-12pt}\begin{otherlanguage}{hebrew}\textbf{\contestname}\\\textbf{\tOverviewSheet}\\ \tLang:\enspace\textbf{\TemplateLanguage}\end{otherlanguage}}
}{}
